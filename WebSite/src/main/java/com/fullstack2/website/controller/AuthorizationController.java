...
public class AuthorizationController {
	...
	try {
	    ...
	    registerMemberService.join(dto.getEmail(), dto.getPassword(), dto.getName(), dto.getPostalCode(),
		    dto.getAddressBasic(), dto.getAddressRest(),

		    dto.getPhoneArea(), dto.getPhoneNumber(), dto.getPhoneExt(), // 여기서 조합한 phone 값을 전달
		    dto.getMobileArea(), dto.getMobileNumber(), dto.getMobileExt(),
		    // 여기서 조합한 mobile 값을 전달
		    dto.getBirthYear(), dto.getBirthMonth(), dto.getBirthDay()
